...
const getApiBaseUrl = () => {
  ...
  // Default to port 8000 (backend Docker container port)
...
export const apiConfig = {
  ...
  endpoints: {
    ...
    // EDS Chat session endpoints
    edsCreateSession: '/api/eds/chat/sessions',
    edsGetSessions: '/api/eds/chat/sessions',
    edsGetSession: (sessionId) => `/api/eds/chat/sessions/${sessionId}`,
    edsDeleteSession: (sessionId) => `/api/eds/chat/sessions/${sessionId}`,
    edsSearchSessions: '/api/eds/chat/sessions/search',
    edsAddMessage: (sessionId) => `/api/eds/chat/sessions/${sessionId}/messages`,
    edsGetBlocks: (sessionId) => `/api/eds/chat/sessions/${sessionId}/blocks`
  },
